...
describe('ToBoolean', ()=>{
    it.each(['true', 'yes', '1', 'on'])(
        'it should return true when passed in a truthy string', (value)=>{
    ...
    it.each(['false', 'no', '0', 'off'])(
        'it should return false when passed in a falsy string', (value)=>{
            const result = plainToClass(MyPayload, { prop: value });
    ...
    it.each(['aad', 'tt', '10', 'whateverstring'])(
        'it should return undefined when passed in a neither truthy nor falsy string', (value)=>{
            const result = plainToClass(MyPayload, { prop: value });
